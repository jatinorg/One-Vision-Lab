                    ...
                    <div className="ai-characteristics-grid">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <div className="ai-char-icon">ΓÜí</div>
                                <p>{item}</p>
                            </motion.div>
                        ))}
                    </div>
                    ...
                    <div className="ai-feature-row">
                        ...
                        >
                            <div className="placeholder-box glass">
                                <span>≡ƒñû Automation Engine</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="ai-section ai-impact">
                <div className="container">
                    ...
                    <div className="ai-impact-grid">
                        {[
                            { val: "Γåæ Engagement", desc: "Higher retention rates" },
                            { val: "Γåæ Conversion", desc: "Optimized user journeys" },
                            { val: "Γåô Ops", desc: "Reduced manual operations" },
                            { val: "Γåæ Velocity", desc: "Faster decision making" }
                        ].map((item, i) => (
